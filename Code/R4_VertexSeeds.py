   ...
   if UserAnswer=='Y':
      ...
      for j in range(0,len(data)):
            for f in range(0,10000):
             new_output_file_location=EOS_DIR+'/EDER-VIANN/Data/REC_SET/VX_REFINED_SET_'+str(j+1)+'_'+str(f)+'.csv'
...
if Mode=='C':
   ...
   test_file=EOS_DIR+'/EDER-VIANN/Data/REC_SET/VX_REC_FINAL_SET.csv'
   ...
   for j in range(0,len(data)):
           for f in range(0,10000):
              new_output_file_location=EOS_DIR+'/EDER-VIANN/Data/REC_SET/VX_REFINED_SET_'+str(j+1)+'_'+str(f)+'.csv'
              required_output_file_location=EOS_DIR+'/EDER-VIANN/Data/REC_SET/VX_REC_SET_'+str(j+1)+'_'+str(f)+'.csv'
              job_details=[(j+1),f,resolution,acceptance,MaxX,MaxY,MaxZ,AFS_DIR,EOS_DIR,ModelName]
