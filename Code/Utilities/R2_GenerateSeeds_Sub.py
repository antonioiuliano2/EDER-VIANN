...
output_file_location=EOS_DIR+'/EDER-VIANN/Data/REC_SET/R2_R2_RawSeeds_'+Set+'_'+str(Subset)+'.csv'
output_result_location=EOS_DIR+'/EDER-VIANN/Data/REC_SET/R2_R2_RawSeeds_'+Set+'_'+str(Subset)+'_RES.csv'
