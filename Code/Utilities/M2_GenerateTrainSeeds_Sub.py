...
output_file_location=EOS_DIR+'/EDER-VIANN/Data/TRAIN_SET/M2_M2_RawSeeds_'+Set+'_'+str(Subset)+'.csv'
output_result_location=EOS_DIR+'/EDER-VIANN/Data/TRAIN_SET/M2_M2_RawSeeds_'+Set+'_'+str(Subset)+'_RES.csv'
